      ...
      <section>
        <div className="container mx-auto pr-28">
          ...
          <p className="text-xl mb-6 leading-9 text-slate-700 dark:text-gray-400">
            ...
            data software and pipelines to solve data driven challenges. I'll talk here about
            things I face during my work and will use this blog as a journal for myself.
          </p>
          <p className="text-xl mb-6 leading-9 text-slate-700 dark:text-gray-400">
